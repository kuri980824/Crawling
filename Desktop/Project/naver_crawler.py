...
def naver_crawler(crpname, start_date='20200101', end_date='20210714'):
    print('\n.....crawling.....')
...
def naver_crawler_ind(start_date='2021-01-01', end_date='2021-06-30'):
    print('\n.....crawling.....')
    start = datetime.datetime.now()
    ...
    idx_list = [2,3,4,5,6,10,11,12,13,14,18,19,20,21,22,26,27,28,29,30,34,35,36,37,38,42,43,44,45,46]
    df = pd.DataFrame(columns = ['date','kapital','title','pdf'])
        ...
        for i in range(30):
            ...
            try:
                ...
                if tr.find_all('td')[0].text == ind:
                    ...
                    record  = pd.Series([date, kap, title, pdf],
                                     index = ['date','kapital','title','pdf'])
                    df = df.append(record, ignore_index = True)
            except:
                pass
